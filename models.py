...
def create_single_fc_model(fingerprint_input, model_settings, is_training):
  ...
  Returns:
    TensorFlow node outputting logit results, and optionally a dropout placeholder.
  """
  if is_training:
...
def create_low_latency_svdf_model(fingerprint_input, model_settings,
  ...
  new_fingerprint_input = fingerprint_input[:, -num_new_frames*input_frequency_size:]
  ...
  weights_frequency = tf.Variable(tf.truncated_normal([input_frequency_size, num_filters], stddev=0.01))
  ...
  activations_time = tf.nn.conv1d(new_fingerprint_input,
                                  weights_frequency, input_frequency_size, 'VALID')
